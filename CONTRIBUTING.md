...
If that gated push ends after publishing the head but before replacing the attestation, repeat the gated push instead of repairing the PR body by hand.
