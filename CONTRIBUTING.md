...
Every later commit, including a fix produced by the gate, must go through no-mistakes again so the pipeline replaces the attestation with one bound to the new head.
