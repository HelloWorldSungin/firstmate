...
- **Read-only fleet board** - an optional loopback-only, mobile-first kanban renders the versioned fleet snapshot contract without owning dispatch, lifecycle, or fleet writes.
...
- [docs/dashboard.md](docs/dashboard.md) - install and operate the loopback-only, read-only fleet kanban service.
