...
exit 0
SH
  chmod +x "$CASE_BIN/dscl" "$CASE_BIN/uname" "$CASE_BIN/id" "$CASE_BIN/launchctl" "$CASE_BIN/tasks-axi" "$CASE_BIN/treehouse" "$CASE_BIN/claude"
...
printf '\nall fm-remote-doctor tests passed\n'
