...
test_rendering_and_session_lifecycle() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-pi-loaded-marker.ts" "$fixture/lib/fm-pi-loaded-marker.ts"
  cp "$ROOT/.pi/extensions/lib/fm-pi-prompt-delivery.ts" "$fixture/lib/fm-pi-prompt-delivery.ts"
