...
cp "$ROOT/.pi/extensions/lib/fm-pi-loaded-marker.ts" "$TMP_ROOT/lib/fm-pi-loaded-marker.ts"
cp "$ROOT/.pi/extensions/lib/fm-pi-prompt-delivery.ts" "$TMP_ROOT/lib/fm-pi-prompt-delivery.ts"
