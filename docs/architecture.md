...
[`bin/fm-run-attribution-legacy-transition.sh`](../bin/fm-run-attribution-legacy-transition.sh) owns the exact proof, bounded lookup, atomic publication, and diagnostic wording.
