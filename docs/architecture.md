...
A `https://github.com/<owner>/<repo>/pull/<n>` URL invokes `gh pr merge <n> --repo <owner>/<repo> --match-head-commit <inspected-head>`, defaults to `--squash`, and preserves explicit merge-method flags.
