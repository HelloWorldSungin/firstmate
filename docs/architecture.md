...
A secondmate's endpoint liveness is never read, so it is admitted to the same bounded cadence only to serve a declared wait and prevent a forgotten pause or captain hold from rotting invisibly.
