...
That keeps each selected launch within its accepted profile axes while preserving the requested profile for later audit; `docs/configuration.md` owns the current support matrix.
