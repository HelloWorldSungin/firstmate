...
| canonical physical identity | a final-component symlink and its target produce the same Lavish source id, and a path whose file and whole directory are gone still resolves to the id derived while the file existed |
