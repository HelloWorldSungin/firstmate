...
[`.agents/skills/harness-adapters/harnesses/muse.md`](../../.agents/skills/harness-adapters/harnesses/muse.md) owns the operating facts; this record owns how they were established and what is still unproven.
