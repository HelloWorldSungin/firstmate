...
| `fm-dashboard-server.mjs` | Serve the loopback captain inbox, kanban, completed-work history, versioned snapshot envelope, and the authenticated agent-event ingest and live timeline |
