...
| `fm-dod-lib.sh`          | One owner of a task's mode-specific definition of done and no-mistakes intent contract, rendered by both the brief scaffold and a scout promotion |
