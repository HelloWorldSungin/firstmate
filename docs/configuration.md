...
FM_DESIGN_CONTEXT_HARD_LIMIT=110000   # design-only: fail-closed context-token ceiling recorded by fm-design-context.sh; firstmate still paces the worker below it
