...
FM_PAUSE_RESURFACE_MAX_STREAK=3    # how many times an unchanged declared wait may double its own recheck window before the cadence stops widening; 0 restores a fixed FM_PAUSE_RESURFACE_SECS cadence
