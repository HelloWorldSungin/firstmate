...
`docs/verification/runtime-backends.md` "Cursor Agent CLI" owns the dated captures; the shared head's "Dated verification evidence" owns the fleet-wide drift guard that refreshes them.
