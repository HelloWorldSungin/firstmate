...
- Underway independently reports active or abandoned work, so an actively worked captain-held task may appear there plus its one decision bucket.
- A secondmate home can contribute to more than one section at once.
  Each active or abandoned child is an Underway row regardless of the home-level `bearings_state`, while that same home's live captain hold is Captain's Call and its queued or external holds stay Charted Next.
  Preserve each abandoned child's identity and missing-worker detail.
