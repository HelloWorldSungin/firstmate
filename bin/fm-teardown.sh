...
# publish the durable outcome manifest, clear volatile state, CLOSE this home's
...
# a landed close removes that record.
...
# gained a turn, a Herdr close that could not be confirmed - withdraws that
