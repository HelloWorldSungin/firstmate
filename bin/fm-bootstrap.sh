...
#          The AXI-family floor policy is owned beside GH_AXI_MIN, CHROME_DEVTOOLS_AXI_MIN, and
...
#          fleet_sync, board_sweep, gbrain_capture_sweep, usage_store_refresh)
...
crew_dispatch_validate() {
  ...
  err=$(jq -r '
    def verified($h): ["claude","codex","opencode","pi","pi-signed","grok","kimi","cursor","muse","gemini","rovo","omp","agy"] | index($h);
    def effort_ok($h; $m; $e):
      if $e == null then true
