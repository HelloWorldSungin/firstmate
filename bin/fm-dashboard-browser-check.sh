...
usage|view-usage|Usage|Work tokens · by project;Usage
...
cat <<'JSON'
{
  ...
  "capture": {"enabled": true, "archived": 12, "pending": 1, "failed": 0, "unreadable": 0, "truncated": 0,
              "last_capture_at": "2026-08-06T22:00:00Z", "last_error": null, "detail": "capture on",
              "audit": {"state": "ok", "stored": 12, "active": 12, "missing": 0,
                        "observed": "2026-08-06T22:05:00Z", "detail": "every captured document is served"}},
  "retrieval": {"state": "ok",
